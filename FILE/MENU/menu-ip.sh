...
APIGIT=$(cat /etc/mdxnetwork/github/api)
EMAILGIT=$(cat /etc/mdxnetwork/github/email)
USERGIT=$(cat /etc/mdxnetwork/github/username)
...
if [[ -f /etc/mdxnetwork/github/api && -f /etc/mdxnetwork/github/email && /etc/mdxnetwork/github/username ]]; then
   rec="OK"
else
    mkdir /etc/mdxnetwork/github > /dev/null 2>&1
fi
...
sleep 2
echo "$EMAIL1" > /etc/mdxnetwork/github/email
echo "$USERNAME1" > /etc/mdxnetwork/github/username
echo "$API1" > /etc/mdxnetwork/github/api
echo "ON" > /etc/mdxnetwork/github/gitstat
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
function resetipvps(){
clear
rm -f /etc/mdxnetwork/github/email
rm -f /etc/mdxnetwork/github/username
rm -f /etc/mdxnetwork/github/api
rm -f /etc/mdxnetwork/github/gitstat
echo "OFF" > /etc/mdxnetwork/github/gitstat
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
GITREQ=/etc/mdxnetwork/github/gitstat
if [ -f "$GITREQ" ]; then
    cekk="ok"
else 
    mkdir /etc/mdxnetwork/github
    touch /etc/mdxnetwork/github/gitstat
    echo "OFF" > /etc/mdxnetwork/github/gitstat
fi

stst1=$(cat /etc/mdxnetwork/github/gitstat)
if [ "$stst1" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}               ${WH}• REGISTER IPVPS •              ${NC} $COLOR1 $NC"
...
stst=$(cat /etc/mdxnetwork/github/gitstat)
if [ "$stst" = "ON" ]; then
APIOK="CEK API"
rex="viewapi"
else
